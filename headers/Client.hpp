...
/*   Updated: 2023/03/09 18:17:41 by gbertin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Client {
	...
	void				sendResponseWithoutPrefixe(const std::string& message) const;
	...
	void				sendResponseToAllChannel(const std::string& message);
